...
page.footerData.655.stdWrap.if.isTrue = {$plugin.tx_csseo.structureddata.search.enable}

### Breadcrumb ###
page.footerData.656 = USER
page.footerData.656.userFunc = Clickstorm\CsSeo\UserFunc\StructuredData->getBreadcrumb
page.footerData.656.stdWrap.if.isTrue = {$plugin.tx_csseo.structureddata.breadcrumb.enable}